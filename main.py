...
# PROGRAM CONSTANTS
NUM_NODES = 10 # how many nodes to create in the graph
EDGE_PROBABILITY = 0.10 # probability of an edge between nodes in random graph
NUM_ITERATIONS = 3 # number of iterations of color mixing to undergo
